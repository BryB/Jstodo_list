    ...
    <div class="form-body">
      <form method="GET">
        ...
        <div class="column">
          ...
          <textarea id="desc" class="textField" name="description"
            placeholder="Description" required></textarea>
      </form>
    </div>
    <div class="form-footer">
      <button id="f_button" class="btn" type="submit"><h1>Submit</h1></button>
    </div>
  </div>
</div>
*/
...
function initFormContent() {
  let inputFields = `<form method="GET">
                      ...
                      <textarea id="desc" class="textField" name="description"
                        placeholder="Description" required></textField>
                    </form>`;
